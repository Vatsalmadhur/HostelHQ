...
const Home = () => {
  return (
    <>
      ...
      <Box sx={{zIndex:-1, height:'30vh'}}> <img src={bg} alt="image"/></Box>
    <Box>
...
<Box
      ...
      >
        ...
        <Typography variant="h1" id="heading" >HostelHQ</Typography>
      ...
      <Box height="auto" width="auto"  margin={0} className="imageOut"><img className="image" src={buildingBG} alt=""/></Box>
      </Box>
    </Box>
